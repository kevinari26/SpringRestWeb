package com.kevinAri.example.config.security;//package com.template.restweb.config.security;
//
...
////				"/configuration/security", "/swagger-ui.html", "/webjars/**", "/spring-security-rest/**").permitAll()
